...
#ifndef __ipa_room_exploration__ROOMEXPLORATIONCONFIG_H__
#define __ipa_room_exploration__ROOMEXPLORATIONCONFIG_H__
...
namespace ipa_room_exploration
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(RoomExplorationConfig &config, const RoomExplorationConfig &max, const RoomExplorationConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const RoomExplorationConfig &config1, const RoomExplorationConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, RoomExplorationConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const RoomExplorationConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, RoomExplorationConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const RoomExplorationConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const RoomExplorationConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, RoomExplorationConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
  ...
  public:
    ...
    void setParams(RoomExplorationConfig &config, const std::vector<AbstractParamDescriptionConstPtr> params)
    {
      for (std::vector<AbstractParamDescriptionConstPtr>::const_iterator _i = params.begin(); _i != params.end(); ++_i)
      {
        ...
        if("max_deviation_from_track"==(*_i)->name){max_deviation_from_track = boost::any_cast<int>(val);}
        if("cell_visiting_order"==(*_i)->name){cell_visiting_order = boost::any_cast<int>(val);}
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(RoomExplorationConfig::AbstractParamDescriptionConstPtr(new RoomExplorationConfig::ParamDescription<int>("room_exploration_algorithm", "int", 0, "Exploration method", "{'enum': [{'name': 'GridPointExplorator', 'type': 'int', 'value': 1, 'srcline': 9, 'srcfile': '/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg', 'description': 'Use the grid point exploration algorithm.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'BoustrophedonExplorator', 'type': 'int', 'value': 2, 'srcline': 10, 'srcfile': '/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg', 'description': 'Use the boustrophedon exploration algorithm.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'NeuralNetworkExplorator', 'type': 'int', 'value': 3, 'srcline': 11, 'srcfile': '/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg', 'description': 'Use the neural network exploration algorithm.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'ConvexSPPExplorator', 'type': 'int', 'value': 4, 'srcline': 12, 'srcfile': '/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg', 'description': 'Use the convexSPP exploration algorithm.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'FlowNetworkExplorator', 'type': 'int', 'value': 5, 'srcline': 13, 'srcfile': '/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg', 'description': 'Use the flowNetwork exploration algorithm.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'EnergyFunctionalExplorator', 'type': 'int', 'value': 6, 'srcline': 14, 'srcfile': '/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg', 'description': 'Use the energyFunctional exploration algorithm.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'VoronoiExplorator', 'type': 'int', 'value': 7, 'srcline': 15, 'srcfile': '/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg', 'description': 'Use the voronoi exploration algorithm.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'BoustrophedonVariantExplorator', 'type': 'int', 'value': 8, 'srcline': 16, 'srcfile': '/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg', 'description': 'Use a variant of the boustrophedon exploration algorithm.', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Exploration algorithm'}", &RoomExplorationConfig::room_exploration_algorithm)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.goal_eps = 1.0;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __max__.goal_eps = std::numeric_limits<double>::infinity();
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.goal_eps = 2.0;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(RoomExplorationConfig::AbstractParamDescriptionConstPtr(new RoomExplorationConfig::ParamDescription<int>("tsp_solver", "int", 0, "Exploration method", "{'enum': [{'name': 'NearestNeighborTSP', 'type': 'int', 'value': 1, 'srcline': 59, 'srcfile': '/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg', 'description': 'Use the Nearest Neighbor TSP algorithm.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'GeneticTSP', 'type': 'int', 'value': 2, 'srcline': 60, 'srcfile': '/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg', 'description': 'Use the Genetic TSP solver.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'ConcordeTSP', 'type': 'int', 'value': 3, 'srcline': 61, 'srcfile': '/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg', 'description': 'Use the Concorde TSP solver.', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Indicates which TSP solver should be used.'}", &RoomExplorationConfig::tsp_solver)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(RoomExplorationConfig::AbstractParamDescriptionConstPtr(new RoomExplorationConfig::ParamDescription<int>("tsp_solver", "int", 0, "Exploration method", "{'enum': [{'name': 'NearestNeighborTSP', 'type': 'int', 'value': 1, 'srcline': 59, 'srcfile': '/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg', 'description': 'Use the Nearest Neighbor TSP algorithm.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'GeneticTSP', 'type': 'int', 'value': 2, 'srcline': 60, 'srcfile': '/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg', 'description': 'Use the Genetic TSP solver.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'ConcordeTSP', 'type': 'int', 'value': 3, 'srcline': 61, 'srcfile': '/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg', 'description': 'Use the Concorde TSP solver.', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Indicates which TSP solver should be used.'}", &RoomExplorationConfig::tsp_solver)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.max_deviation_from_track = -1;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __max__.max_deviation_from_track = 2147483647;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.max_deviation_from_track = -1;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(RoomExplorationConfig::AbstractParamDescriptionConstPtr(new RoomExplorationConfig::ParamDescription<int>("max_deviation_from_track", "int", 0, "Maximal allowed shift off the ideal boustrophedon track for avoiding obstacles on track, in [pixel]. For negative values max_deviation_from_track is automatically set to grid_spacing.", "", &RoomExplorationConfig::max_deviation_from_track)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(RoomExplorationConfig::AbstractParamDescriptionConstPtr(new RoomExplorationConfig::ParamDescription<int>("max_deviation_from_track", "int", 0, "Maximal allowed shift off the ideal boustrophedon track for avoiding obstacles on track, in [pixel]. For negative values max_deviation_from_track is automatically set to grid_spacing.", "", &RoomExplorationConfig::max_deviation_from_track)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.cell_visiting_order = 1;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __max__.cell_visiting_order = 2;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.cell_visiting_order = 1;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(RoomExplorationConfig::AbstractParamDescriptionConstPtr(new RoomExplorationConfig::ParamDescription<int>("cell_visiting_order", "int", 0, "Cell visiting order method", "{'enum': [{'name': 'OptimalTSP', 'type': 'int', 'value': 1, 'srcline': 85, 'srcfile': '/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg', 'description': 'The optimal visiting order of the cells is determined as TSP problem.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'LeftToRight', 'type': 'int', 'value': 2, 'srcline': 86, 'srcfile': '/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg', 'description': 'Alternative ordering from left to right (measured on y-coordinates of the cells), visits the cells in a more obvious fashion to the human observer (though it is not optimal).', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Cell visiting order'}", &RoomExplorationConfig::cell_visiting_order)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(RoomExplorationConfig::AbstractParamDescriptionConstPtr(new RoomExplorationConfig::ParamDescription<int>("cell_visiting_order", "int", 0, "Cell visiting order method", "{'enum': [{'name': 'OptimalTSP', 'type': 'int', 'value': 1, 'srcline': 85, 'srcfile': '/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg', 'description': 'The optimal visiting order of the cells is determined as TSP problem.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'LeftToRight', 'type': 'int', 'value': 2, 'srcline': 86, 'srcfile': '/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg', 'description': 'Alternative ordering from left to right (measured on y-coordinates of the cells), visits the cells in a more obvious fashion to the human observer (though it is not optimal).', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Cell visiting order'}", &RoomExplorationConfig::cell_visiting_order)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 9 "/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg"
      const int RoomExploration_GridPointExplorator = 1;
//#line 10 "/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg"
      const int RoomExploration_BoustrophedonExplorator = 2;
//#line 11 "/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg"
      const int RoomExploration_NeuralNetworkExplorator = 3;
//#line 12 "/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg"
      const int RoomExploration_ConvexSPPExplorator = 4;
//#line 13 "/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg"
      const int RoomExploration_FlowNetworkExplorator = 5;
//#line 14 "/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg"
      const int RoomExploration_EnergyFunctionalExplorator = 6;
//#line 15 "/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg"
      const int RoomExploration_VoronoiExplorator = 7;
//#line 16 "/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg"
      const int RoomExploration_BoustrophedonVariantExplorator = 8;
//#line 59 "/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg"
      const int RoomExploration_NearestNeighborTSP = 1;
//#line 60 "/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg"
      const int RoomExploration_GeneticTSP = 2;
//#line 61 "/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg"
      const int RoomExploration_ConcordeTSP = 3;
//#line 85 "/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg"
      const int RoomExploration_OptimalTSP = 1;
//#line 86 "/home/taylor/room_exp/src/ipa_room_exploration/cfg/RoomExploration.cfg"
      const int RoomExploration_LeftToRight = 2;
}
