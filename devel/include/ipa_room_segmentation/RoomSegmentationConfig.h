...
namespace ipa_room_segmentation
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(RoomSegmentationConfig &config, const RoomSegmentationConfig &max, const RoomSegmentationConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const RoomSegmentationConfig &config1, const RoomSegmentationConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, RoomSegmentationConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const RoomSegmentationConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, RoomSegmentationConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const RoomSegmentationConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const RoomSegmentationConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, RoomSegmentationConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(RoomSegmentationConfig::AbstractParamDescriptionConstPtr(new RoomSegmentationConfig::ParamDescription<int>("room_segmentation_algorithm", "int", 0, "Segmentation method", "{'enum': [{'name': 'MorphologicalSegmentation', 'type': 'int', 'value': 1, 'srcline': 8, 'srcfile': '/home/taylor/room_exp/src/ipa_room_segmentation/cfg/RoomSegmentation.cfg', 'description': 'Use the morphological segmentation algorithm.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'DistanceSegmentation', 'type': 'int', 'value': 2, 'srcline': 9, 'srcfile': '/home/taylor/room_exp/src/ipa_room_segmentation/cfg/RoomSegmentation.cfg', 'description': 'Use the distance segmentation algorithm.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'VoronoiSegmentation', 'type': 'int', 'value': 3, 'srcline': 10, 'srcfile': '/home/taylor/room_exp/src/ipa_room_segmentation/cfg/RoomSegmentation.cfg', 'description': 'Use the Voronoi segmentation algorithm.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'SemanticSegmentation', 'type': 'int', 'value': 4, 'srcline': 11, 'srcfile': '/home/taylor/room_exp/src/ipa_room_segmentation/cfg/RoomSegmentation.cfg', 'description': 'Use the semantic/feature-based segmentation algorithm.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'RandomFieldSegmentation', 'type': 'int', 'value': 5, 'srcline': 12, 'srcfile': '/home/taylor/room_exp/src/ipa_room_segmentation/cfg/RoomSegmentation.cfg', 'description': 'Use the voronoi-random-field segmentation algorithm.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'PassThroughSegmentation', 'type': 'int', 'value': 99, 'srcline': 13, 'srcfile': '/home/taylor/room_exp/src/ipa_room_segmentation/cfg/RoomSegmentation.cfg', 'description': 'Use the pass through segmentation algorithm.', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Segmentation algorithm'}", &RoomSegmentationConfig::room_segmentation_algorithm)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 8 "/home/taylor/room_exp/src/ipa_room_segmentation/cfg/RoomSegmentation.cfg"
      const int RoomSegmentation_MorphologicalSegmentation = 1;
//#line 9 "/home/taylor/room_exp/src/ipa_room_segmentation/cfg/RoomSegmentation.cfg"
      const int RoomSegmentation_DistanceSegmentation = 2;
//#line 10 "/home/taylor/room_exp/src/ipa_room_segmentation/cfg/RoomSegmentation.cfg"
      const int RoomSegmentation_VoronoiSegmentation = 3;
//#line 11 "/home/taylor/room_exp/src/ipa_room_segmentation/cfg/RoomSegmentation.cfg"
      const int RoomSegmentation_SemanticSegmentation = 4;
//#line 12 "/home/taylor/room_exp/src/ipa_room_segmentation/cfg/RoomSegmentation.cfg"
      const int RoomSegmentation_RandomFieldSegmentation = 5;
//#line 13 "/home/taylor/room_exp/src/ipa_room_segmentation/cfg/RoomSegmentation.cfg"
